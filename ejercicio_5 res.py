...
# ya elaborada
def generar_invitados(ingresos):
    lista_ingresos = []
    while len(lista_ingresos) <= 10:

        ingresos = str(input("Ingrese nombre de invitado "))
        lista_ingresos.append(ingresos)
...
if __name__ == '__main__':
    ...
    lista_invitados = generar_invitados(ingresos)
